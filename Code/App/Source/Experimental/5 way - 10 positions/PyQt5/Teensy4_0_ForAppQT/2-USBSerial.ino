        ...
        switch (instruction) {
          case 'Z':  // Save pos 1
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M1"); } 
              else if (camNumInst == '3') { Serial2.println("?M1"); } 
          ...
          case 'X':  // Save pos 2
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M2"); } 
              else if (camNumInst == '3') { Serial2.println("?M2"); } 
          ...
          case 'C':  // Save pos 3
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M3"); } 
              else if (camNumInst == '3') { Serial2.println("?M3"); } 
          ...
          case 'V':  // Save pos 4
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M4"); } 
              else if (camNumInst == '3') { Serial2.println("?M4"); } 
          ...
          case 'B':  // Save pos 5
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M5"); } 
              else if (camNumInst == '3') { Serial2.println("?M5"); } 
          ...
          case 'N':  // Save pos 6
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M6"); } 
              else if (camNumInst == '3') { Serial2.println("?M6"); } 
          ...
          case 'M':  // Save pos 7
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M7"); } 
              else if (camNumInst == '3') { Serial2.println("?M7"); } 
          ...
          case '<':  // Save pos 8
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M8"); } 
              else if (camNumInst == '3') { Serial2.println("?M8"); } 
          ...
          case '>':  // Save pos 9
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?M9"); } 
              else if (camNumInst == '3') { Serial2.println("?M9"); } 
          ...
          case 'a':  // Zoom out
            {
              ...
              if (instruction == '8') {
                ...
                else if (camNumInst == '2') { Serial3.println("?z8"); } 
                else if (camNumInst == '3') { Serial2.println("?z8"); } 
          ...
          case 'q':  // Zoom STOP
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?N"); } 
              else if (camNumInst == '3') { Serial2.println("?N"); } 
          ...
          case 'd':  // Toggle recording
            {
              ...
              else if (camNumInst == '2') { Serial3.println("?u"); } 
              else if (camNumInst == '3') { Serial2.println("?u"); } 
          ...
          case 'D':
            {  // Cam 1, Clear Positions
              ...
              else if (camNumInst == '2') { Serial3.println("?Y"); } 
              else if (camNumInst == '3') { Serial2.println("?Y"); } 
          ...
          case 'r':
            {  // Report
              ...
              else if (camNumInst == '2') { Serial3.println("?r"); } 
              else if (camNumInst == '3') { Serial2.println("?r"); } 
          ...
          case 'k':
            {  // Keyframe Report
              ...
              else if (camNumInst == '2') { Serial3.println("?k"); } 
              else if (camNumInst == '3') { Serial2.println("?k"); } 
