...
<MainWindow>:
    ...
    MDScreen:
        ...
        canvas:
            ...
            #PT
            Rectangle:
                pos: (app.xDiv*21), (app.yDiv*63)
                size: (app.xDiv*72), (app.yDiv*6)
            
            Rectangle:
                pos: (app.xDiv*102), (app.yDiv*63)
                size: (app.xDiv*10), (app.yDiv*6)

            #Slider
            Rectangle:
                pos: (app.xDiv*21), (app.yDiv*39)
                size: (app.xDiv*72), (app.yDiv*6)
            
            Rectangle:
                pos: (app.xDiv*102), (app.yDiv*39)
                size: (app.xDiv*10), (app.yDiv*6)

            #Zoom
            Rectangle:
                pos: (app.xDiv*21), (app.yDiv*14)
                size: (app.xDiv*72), (app.yDiv*6)
            
            Rectangle:
                pos: (app.xDiv*102), (app.yDiv*14)
                size: (app.xDiv*10), (app.yDiv*6)
            ...
            #Cam1 Speed BG
            Rectangle:
                pos: (app.xDiv*25), (app.yDiv*63)
                size: (app.xDiv*24), (app.yDiv*6)
            Rectangle:
                pos: (app.xDiv*65), (app.yDiv*63)
                size: (app.xDiv*24), (app.yDiv*6)

            #Cam2 Speed BG
            Rectangle:
                pos: (app.xDiv*25), (app.yDiv*39)
                size: (app.xDiv*24), (app.yDiv*6)
            Rectangle:
                pos: (app.xDiv*65), (app.yDiv*39)
                size: (app.xDiv*24), (app.yDiv*6)

            #Cam3 Speed BG
            Rectangle:
                pos: (app.xDiv*25), (app.yDiv*14)
                size: (app.xDiv*24), (app.yDiv*6)
            Rectangle:
                pos: (app.xDiv*65), (app.yDiv*14)
                size: (app.xDiv*24), (app.yDiv*6)
        ...
        Button:
            ...
            on_touch_down: app.setPos(3)


        Button:
            id: btnCam1Go1
            text:"1"
            pos: (app.xDiv*1), (app.yDiv*50)
            size: (app.xDiv*12), (app.yDiv*12)
            size_hint: None, None
            font_size: (app.yDiv*3)
            col: .13, .13, .13, 1
            background_normal: ''
            background_color: get_color_from_hex(app.Cam1ButColour)
            on_touch_down: app.Cam1Go1()
            canvas.before:
                Color: 
                    rgba: self.col
                Line:
...
class PTSApp(MDApp):
    ...
    def doButtonColours(self):
        ...
        if oldCam1PTSpeed != cam1PTSpeed:
            ...
            if cam1PTSpeed == 1:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*6), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 1/4")
                client.send_message("/style/text/4/10", "Spd 1/4")
            elif cam1PTSpeed == 3:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*12), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 2/4")
                client.send_message("/style/text/4/10", "Spd 2/4")
            elif cam1PTSpeed == 5:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*18), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 3/4")
                client.send_message("/style/text/4/10", "Spd 3/4")
            elif cam1PTSpeed == 7:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*24), (yDivSet*6))
        ...
        if oldCam2PTSpeed != cam2PTSpeed:
            ...
            if cam2PTSpeed == 1:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*6), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 1/4")
                client.send_message("/style/text/5/10", "Spd 1/4")
            elif cam2PTSpeed == 3:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*12), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 2/4")
                client.send_message("/style/text/5/10", "Spd 2/4")
            elif cam2PTSpeed == 5:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*18), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 3/4")
                client.send_message("/style/text/5/10", "Spd 3/4")
            elif cam2PTSpeed == 7:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*24), (yDivSet*6))
        ...
        if oldCam3PTSpeed != cam3PTSpeed:
            ...
            if cam3PTSpeed == 1:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*6), (yDivSet*6))
                client.send_message("/style/text/3/24", "+ 1/4")
                client.send_message("/style/text/6/10", "Spd 1/4")
            elif cam3PTSpeed == 3:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*12), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 2/4")
                client.send_message("/style/text/6/10", "Spd 2/4")
            elif cam3PTSpeed == 5:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*18), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 3/4")
                client.send_message("/style/text/6/10", "Spd 3/4")
            elif cam3PTSpeed == 7:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*24), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 4/4")
        ...
        if oldCam1Speed != cam1SliderSpeed:
            ...
            if cam1SliderSpeed == 1:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*3.43), (yDivSet*6))
            elif cam1SliderSpeed == 2:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*6.86), (yDivSet*6))
            elif cam1SliderSpeed == 3:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*10.23), (yDivSet*6))
            elif cam1SliderSpeed == 4:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*13.71), (yDivSet*6))
            elif cam1SliderSpeed == 5:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*17.14), (yDivSet*6))
            elif cam1SliderSpeed == 6:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*20.57), (yDivSet*6))
            elif cam1SliderSpeed == 7:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*24), (yDivSet*6))

        if oldCam2Speed != cam2SliderSpeed:
            oldCam2Speed = cam2SliderSpeed
            if cam2SliderSpeed == 1:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*3.43), (yDivSet*6))
            elif cam2SliderSpeed == 2:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*6.86), (yDivSet*6))
            elif cam2SliderSpeed == 3:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*10.23), (yDivSet*6))
            elif cam2SliderSpeed == 4:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*13.71), (yDivSet*6))
            elif cam2SliderSpeed == 5:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*17.14), (yDivSet*6))
            elif cam2SliderSpeed == 6:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*20.57), (yDivSet*6))
            elif cam2SliderSpeed == 7:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*24), (yDivSet*6))

        if oldCam3Speed != cam3SliderSpeed:
            oldCam3Speed = cam3SliderSpeed
            if cam3SliderSpeed == 1:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*3.43), (yDivSet*6))
            elif cam3SliderSpeed == 2:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*6.86), (yDivSet*6))
            elif cam3SliderSpeed == 3:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*10.23), (yDivSet*6))
            elif cam3SliderSpeed == 4:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*13.71), (yDivSet*6))
            elif cam3SliderSpeed == 5:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*17.14), (yDivSet*6))
            elif cam3SliderSpeed == 6:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*20.57), (yDivSet*6))
            elif cam3SliderSpeed == 7:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*24), (yDivSet*6))
