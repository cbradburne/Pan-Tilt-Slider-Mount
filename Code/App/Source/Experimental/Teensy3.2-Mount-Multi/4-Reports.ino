...
void printKeyframeElements(void) {
  ...
  do {
    ...
    */
    ...
    Serial1.print(String("Post move Delay: ") + keyframe_array[row].runDelay + String(" ms\t"));
    Serial1.println(String("Array move accel: ") + keyframe_array[row].runAccel + String(" steps/s²"));
    Serial1.println("-");
