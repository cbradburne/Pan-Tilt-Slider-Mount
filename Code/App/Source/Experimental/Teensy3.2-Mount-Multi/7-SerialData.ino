...
void SerialData(void) {
  ...
  if (Serial.available() > 0) {
    ...
    if (instruction == INSTRUCTION_BYTES_SLIDER_PAN_TILT_SPEED) {
      ...
      instruction = Serial.read();
      if (instruction == INSTRUCTION_IS_CAM_ACCEL) {
        delay(2);
        dlyPos = Serial.read();
      ...
      else if (instruction == INSTRUCTION_IS_CAM_SPEEDPT) {
        delay(2);
        dlyPos = Serial.read();
        memset(&stringText[0], 0, sizeof(stringText));            //clear the array
        while (Serial.available()) {                              //set elemetns of stringText to the Serial1 values sent
      ...
      else if (instruction == INSTRUCTION_IS_CAM_SPEEDSl) {
        delay(2);
        dlyPos = Serial.read();
        memset(&stringText[0], 0, sizeof(stringText));            //clear the array
        while (Serial.available()) {                              //set elemetns of stringText to the Serial1 values sent
      ...
      else if (instruction == INSTRUCTION_IS_CAM_DELAY) {
        delay(2);
        dlyPos = Serial.read();
        memset(&stringText[0], 0, sizeof(stringText));            //clear the array
        while (Serial.available()) {                              //set elemetns of stringText to the Serial1 values sent
    ...
    if (instruction == INSTRUCTION_BYTES_SLIDER_PAN_TILT_SPEED) {
      ...
      if (instruction == INSTRUCTION_IS_CAM_ACCEL) {
        ...
        dlyPos = Serial2.read();
        memset(&stringText[0], 0, sizeof(stringText));            //clear the array
        while (Serial2.available()) {                              //set elemetns of stringText to the Serial1 values sent
    ...
    if (instruction == INSTRUCTION_BYTES_SLIDER_PAN_TILT_SPEED) {
      ...
      if (instruction == INSTRUCTION_IS_CAM_ACCEL) {
        ...
        dlyPos = Serial3.read();
        memset(&stringText[0], 0, sizeof(stringText));            //clear the array
        while (Serial3.available()) {                              //set elemetns of stringText to the Serial1 values sent
  ...
  switch (instruction) {
    case INSTRUCTION_IS_CAM_ACCEL: {
        if (dlyPos == 49) {
          keyframe_array[0].runAccel = SerialCommandValueInt;
          Serial1.print("Acceleration to 2nd position set: ");
          Serial1.print(keyframe_array[0].runAccel);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 50) {
          keyframe_array[1].runAccel = SerialCommandValueInt;
          Serial1.print("Acceleration to 3rd position set: ");
          Serial1.print(keyframe_array[1].runAccel);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 51) {
          keyframe_array[2].runAccel = SerialCommandValueInt;
          Serial1.print("Acceleration to 4th position set: ");
          Serial1.print(keyframe_array[2].runAccel);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 52) {
          keyframe_array[3].runAccel = SerialCommandValueInt;
          Serial1.print("Acceleration to 5th position set: ");
          Serial1.print(keyframe_array[3].runAccel);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 53) {
          keyframe_array[4].runAccel = SerialCommandValueInt;
          Serial1.print("Acceleration to 6th position set: ");
          Serial1.print(keyframe_array[4].runAccel);
          Serial1.println(" steps/s²\n");
        }
      }
      break;
    case INSTRUCTION_IS_CAM_SPEEDPT: {
        if (dlyPos == 49) {
          keyframe_array[0].panSpeed = SerialCommandValueInt;
          keyframe_array[0].tiltSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 2nd position set: ");
          Serial1.print(keyframe_array[0].panSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 50) {
          keyframe_array[1].panSpeed = SerialCommandValueInt;
          keyframe_array[1].tiltSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 3rd position set: ");
          Serial1.print(keyframe_array[1].panSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 51) {
          keyframe_array[2].panSpeed = SerialCommandValueInt;
          keyframe_array[2].tiltSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 4th position set: ");
          Serial1.print(keyframe_array[2].panSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 52) {
          keyframe_array[3].panSpeed = SerialCommandValueInt;
          keyframe_array[3].tiltSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 5th position set: ");
          Serial1.print(keyframe_array[3].panSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 53) {
          keyframe_array[4].panSpeed = SerialCommandValueInt;
          keyframe_array[4].tiltSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 6th position set: ");
          Serial1.print(keyframe_array[4].panSpeed);
          Serial1.println(" steps/s²\n");
        }
      }
      break;
    case INSTRUCTION_IS_CAM_SPEEDSl: {
        if (dlyPos == 49) {
          keyframe_array[0].sliderSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 2nd position set: ");
          Serial1.print(keyframe_array[0].sliderSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 50) {
          keyframe_array[1].sliderSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 3rd position set: ");
          Serial1.print(keyframe_array[1].sliderSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 51) {
          keyframe_array[2].sliderSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 4th position set: ");
          Serial1.print(keyframe_array[2].sliderSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 52) {
          keyframe_array[3].sliderSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 5th position set: ");
          Serial1.print(keyframe_array[3].sliderSpeed);
          Serial1.println(" steps/s²\n");
        }
        else if (dlyPos == 53) {
          keyframe_array[4].sliderSpeed = SerialCommandValueInt;
          Serial1.print("Pan/Tilt Speed to 6th position set: ");
          Serial1.print(keyframe_array[4].sliderSpeed);
          Serial1.println(" steps/s²\n");
        }
      }
      break;
    case INSTRUCTION_IS_CAM_DELAY: {
        if (dlyPos == 49) {
          keyframe_array[0].runDelay = SerialCommandValueInt;
          Serial1.print("Delay before 2nd position set: ");
          Serial1.print(keyframe_array[0].runDelay);
          Serial1.println("ms\n");
        }
        else if (dlyPos == 50) {
          keyframe_array[1].runDelay = SerialCommandValueInt;
          Serial1.print("Delay before 3rd position set: ");
          Serial1.print(keyframe_array[1].runDelay);
          Serial1.println("ms\n");
        }
        else if (dlyPos == 51) {
          keyframe_array[2].runDelay = SerialCommandValueInt;
          Serial1.print("Delay before 4th position set: ");
          Serial1.print(keyframe_array[2].runDelay);
          Serial1.println("ms\n");
        }
        else if (dlyPos == 52) {
          keyframe_array[3].runDelay = SerialCommandValueInt;
          Serial1.print("Delay before 5th position set: ");
          Serial1.print(keyframe_array[3].runDelay);
          Serial1.println("ms\n");
        }
        else if (dlyPos == 53) {
          keyframe_array[4].runDelay = SerialCommandValueInt;
          Serial1.print("Delay before 6th position set: ");
          Serial1.print(keyframe_array[4].runDelay);
          Serial1.println("ms\n");
        }
      }
      break;
