...
class PTSApp(MDApp):
    ...
    def keyUp(self, instance, keyboard, keycode):
        ...
        if self.root.get_screen('main').ids.textInput.focus == False:              #   a= 4, s= 22, d=7, w= 26, ,=54, .=55
            #print(keycode)
            if keycode == 4:
                axisX = 0
            if keycode == 7:
    ...
    def keyDown(self, instance, keyboard, keycode, text, modifiers):
        ...
        if keycode == 40:                                                                   # Return key pressed
            if self.root.get_screen('main').ids.textInput.focus == True:
                print("main pressed")
    ...
    def on_btn_scan_release(self):
        ...
        if not btn_scan_show:
            ...
            if (usb_port in '\t'.join(self.device_name_list)):
                ...
                self.root.get_screen('main').ids.scanDD.pos = (((xDivSet*110)-(xDivSet*(longestSerial/2))), ((yDivSet*65) - ((yDivSet*7.4) * len(usb_device_list))))
                if platform == "win32" or platform == "Windows" or platform == "win":
                    self.root.get_screen('main').ids.box_list.size = (((xDivSet*(longestSerial*1.4))), 0)
                else:
                    self.root.get_screen('main').ids.box_list.size = (((xDivSet*(longestSerial*0.8))), 0)
        else:
            btn_scan_show = False
            self.uiDict['box_list'].clear_widgets()
    ...
    def on_btn_help_release(self):
        ...
        if not btn_help_show:
            ...
            self.root.get_screen('main').ids.helpLabel.visible =  True
            self.root.get_screen('main').ids.helpCanvas.visible =  True
        elif btn_help_show:
            btn_help_show = False

            self.root.get_screen('main').ids.helpLabel.visible =  False
            self.root.get_screen('main').ids.helpCanvas.visible =  False
    ...
    def doButtonColours(self):
        ...
        if oldCam1PTSpeed != cam1PTSpeed:
            ...
            if cam1PTSpeed == 1:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*2.25), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 1/4")
                client.send_message("/style/text/4/10", "Spd 1/4")
            elif cam1PTSpeed == 3:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*4.5), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 2/4")
                client.send_message("/style/text/4/10", "Spd 2/4")
            elif cam1PTSpeed == 5:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*6.75), (yDivSet*6))
                client.send_message("/style/text/3/8", "+ 3/4")
                client.send_message("/style/text/4/10", "Spd 3/4")
            elif cam1PTSpeed == 7:
                self.root.get_screen('main').ids.cam1PTSpd.sizPT1=((xDivSet*9), (yDivSet*6))
        ...
        if oldCam2PTSpeed != cam2PTSpeed:
            ...
            if cam2PTSpeed == 1:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*2.25), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 1/4")
                client.send_message("/style/text/5/10", "Spd 1/4")
            elif cam2PTSpeed == 3:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*4.5), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 2/4")
                client.send_message("/style/text/5/10", "Spd 2/4")
            elif cam2PTSpeed == 5:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*6.75), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 3/4")
                client.send_message("/style/text/5/10", "Spd 3/4")
            elif cam2PTSpeed == 7:
                self.root.get_screen('main').ids.cam2PTSpd.sizPT2=((xDivSet*9), (yDivSet*6))
        ...
        if oldCam3PTSpeed != cam3PTSpeed:
            ...
            if cam3PTSpeed == 1:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*2.25), (yDivSet*6))
                client.send_message("/style/text/3/24", "+ 1/4")
                client.send_message("/style/text/6/10", "Spd 1/4")
            elif cam3PTSpeed == 3:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*4.5), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 2/4")
                client.send_message("/style/text/6/10", "Spd 2/4")
            elif cam3PTSpeed == 5:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*6.75), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 3/4")
                client.send_message("/style/text/6/10", "Spd 3/4")
            elif cam3PTSpeed == 7:
                self.root.get_screen('main').ids.cam3PTSpd.sizPT3=((xDivSet*9), (yDivSet*6))
                client.send_message("/style/text/3/16", "+ 4/4")
        ...
        if oldCam1Speed != cam1SliderSpeed:
            ...
            if cam1SliderSpeed == 1:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*1.29), (yDivSet*6))
            elif cam1SliderSpeed == 2:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*2.57), (yDivSet*6))
            elif cam1SliderSpeed == 3:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*3.86), (yDivSet*6))
            elif cam1SliderSpeed == 4:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*5.14), (yDivSet*6))
            elif cam1SliderSpeed == 5:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*6.43), (yDivSet*6))
            elif cam1SliderSpeed == 6:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*7.71), (yDivSet*6))
            elif cam1SliderSpeed == 7:
                self.root.get_screen('main').ids.cam1SlSpd.sizSl1=((xDivSet*9), (yDivSet*6))

        if oldCam2Speed != cam2SliderSpeed:
            oldCam2Speed = cam2SliderSpeed
            if cam2SliderSpeed == 1:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*1.29), (yDivSet*6))
            elif cam2SliderSpeed == 2:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*2.57), (yDivSet*6))
            elif cam2SliderSpeed == 3:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*3.86), (yDivSet*6))
            elif cam2SliderSpeed == 4:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*5.14), (yDivSet*6))
            elif cam2SliderSpeed == 5:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*6.43), (yDivSet*6))
            elif cam2SliderSpeed == 6:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*7.71), (yDivSet*6))
            elif cam2SliderSpeed == 7:
                self.root.get_screen('main').ids.cam2SlSpd.sizSl2=((xDivSet*9), (yDivSet*6))

        if oldCam3Speed != cam3SliderSpeed:
            oldCam3Speed = cam3SliderSpeed
            if cam3SliderSpeed == 1:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*1.29), (yDivSet*6))
            elif cam3SliderSpeed == 2:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*2.57), (yDivSet*6))
            elif cam3SliderSpeed == 3:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*3.86), (yDivSet*6))
            elif cam3SliderSpeed == 4:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*5.14), (yDivSet*6))
            elif cam3SliderSpeed == 5:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*6.43), (yDivSet*6))
            elif cam3SliderSpeed == 6:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*7.71), (yDivSet*6))
            elif cam3SliderSpeed == 7:
                self.root.get_screen('main').ids.cam3SlSpd.sizSl3=((xDivSet*9), (yDivSet*6))
